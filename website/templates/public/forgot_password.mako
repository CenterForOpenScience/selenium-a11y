        ...
        <form class="form col-md-4 col-md-offset-4 m-t-xl"
            ...
            <div class="panel panel-osf">
                <div class="panel-heading">Password reset request</div>
                    <div class="panel-body">
                        <input type="email" class="form-control" data-bind="value: username" name="forgot_password-email" placeholder="Enter your email address"  aria-label="Email Address Input" autofocus/>
