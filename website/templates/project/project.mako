                ...
                <div class="btn-toolbar node-control pull-right">
                    ...
                    <div class="btn-group">
                        <div class="generic-dropdown dropdown pull-right">
                            <button id="otherActionsButton" class="btn btn-default dropdown-toggle disabled" type="button" data-toggle="dropdown" aria-label="Other Actions Dropdown" >
        ...
        <div class="panel panel-default">
            <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                   <a href="${node['url']}files/"> <i class="fa fa-external-link" aria-label="Link to Files Page"></i> </a>
                </div>
            </div>
        ...
        % if not node['anonymous']:
         ...
         <div class="citations panel panel-default">
             <div class="panel-heading clearfix">
                ...
                <div class="pull-right">
                    <button class="btn btn-link project-toggle" aria-label="Toggle" ><i class="fa fa-angle-down"></i></button>
                </div>
             </div>
             <div id="citationList">
